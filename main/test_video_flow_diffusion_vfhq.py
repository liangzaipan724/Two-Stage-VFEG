...
from datastes_vfhq import VFHQ_test
import random
...
def main():
    ...
    model = FlowDiffusion(is_train=True,
                          ...
                          pretrained_pth="/data/HDD1/vfhq/VFHQ.pth")
    model.cuda()
    ...
    setup_seed(args.random_seed)
    testloader = data.DataLoader(VFHQ_test(data_dir=data_dir,
