...
import torch
from stage_one.modules.util import Hourglass, AntiAliasInterpolation2d, make_coordinate_grid, region2gaussian
from stage_one.modules.util import to_homogeneous, from_homogeneous
